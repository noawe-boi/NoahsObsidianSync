...
# Introduction
## Executive Summary
The HiChord, by Pocket Audio (PA) is positioned to enter the market of music production equipment, targeting the broad niche of user accessible, novel and portable synthesizers, later this year. The music production industry is projected to see large grows i the coming years, with the synthesizer segment specifically
