...
Considering the reaction taking place, 
The ratio of $HCl$ to $MgCO_3$ is $2:1$.
(*$MgCO_3​(s)+2HCl(aq)→MgCl_2​(aq)+H_2​O(l)+CO_2​(g)$)

 The number of moles of $MgCO_3$ is smaller than the number of moles of $HCl$. This means that $MgCO_3$ will be the limiting reactant in this reaction.
