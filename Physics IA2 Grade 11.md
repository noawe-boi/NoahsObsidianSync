...
Relying on human perception of sound creates too many variables for it to be viable when any sort of precision is needed. Additionally, changing the harmonic 
