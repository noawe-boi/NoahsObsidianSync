...
A dB meter was used to determine when the pipe was tuned to a harmonic as it could discretely measure magnitude. Additionally, Instead of changing the frequency of the sound wave to change harmonic, the length of the pipe was altered.
