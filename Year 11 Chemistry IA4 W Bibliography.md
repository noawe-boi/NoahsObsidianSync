...
Figure 10 clearly demonstrates this and shows that even for the same fuel, the amount of $CO_2$ per kilometre varied significantly. For example, E10's value varies by over $117 g/km$ with Source 1 having the largest value, and Source 3 having the smallest.  
This is likely due to 3 main factors. The first factor is the differences in vehicle used during testing. Source 1 did not list a motor vehicle or specific load cycle. Source 2 utilised a Holden GCG Captiva 7, a mid sized SUV. Source 3 utilised a Ford Focus 1.8 Duratec Flexi-fuel, a mid sized hatchback. All of these vehicles have significant variance in their weight, engine specifications, aerodynamics and overall efficiency.  
