...
A dB meter was used to determine when the pipe was tuned to a harmonic as it could objectivley and quantitively measure sound intensity. Additionally, Instead of changing the harmonic of the sound wave to change harmonic, the length of the pipe was altered, which reduced the range of frequencies that had to be played
