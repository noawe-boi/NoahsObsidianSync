...
The frequency of the 7th harmonic was first estimated using the formula $f=\frac{7}{4}*V*\frac{1}{L}$ where $f$ is the frequency of the wave, which was derived from the formula $L=\frac{n\lambda}{4}$. 
