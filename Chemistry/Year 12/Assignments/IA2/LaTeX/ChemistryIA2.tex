...
The scatter plot produced using experimental data suggests a linear relationship. Using desmos, linear and logarithmic and linear lines of best fit were found. The linear regression showed a greater correlation than the logarithmic trendline, as $R^2_\textrm{Lin}=0.6426>R^2_\textrm{Log}=0.4082$.
...
While the trend observed resembles a linear relationship, divergence from the Nernst equation is what this experiment sought out to investigate, and therefore this result is perfectly valid. It should be noted however that the data is very noisy and does not entirely point to this relationship, as $R^2_\textrm{Lin}=0.6426<1$.
