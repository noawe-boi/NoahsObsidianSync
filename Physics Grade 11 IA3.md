...
It can be observed that as the frequency of the wave increases, the conductivity, or S/m value, increases, while penetration, or the $\delta$/mm value, decreases. In addition to this, tissues containting higher water content, such as skin and muscle, have the highest conductivity at al frequencies  For example, at 150MHz, conductivity ranges from 0.04 S/m in fat, to 0.7 
