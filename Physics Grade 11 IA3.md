...
Non ionising radiation cannot directly alter DNA, but can pose risk to the body. For example, microwaves are a common household appliance that most commonly operate at 2.45GHz. This frequency creates am optimal wavelength for polarised water molecules to rapidly rotate and create friction between each other, which then creates heat. While this process does not directly 
